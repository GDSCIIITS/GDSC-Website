...
const About = () => {
  ...
  return (
    <div className={classname}>
      <h2 className={`container ${classname}`}>
      ...
      <div className={`container ${styles.container} ${classname}`}>
        <p className={styles.maintext + " " + classname}>
          <h2 className={"google-font " + classname}>
            <b className={classname}>Community Guidelines</b>
          </h2>
          ...
          <h2 className={"google-font " + classname}>
            {" "}
            <b className={classname}>Code of Conduct</b>
          </h2>
          ...
          for everyone. These guidelines cover both online (e.g. mailing lists,
          social channels) and offline (e.g. in-person meetups) behavior.
          Violations of this code of conduct can result in members being removed
          from the program. Use your best judgment, and if you'd like more
          clarity or have questions feel free to reach out.
          <br />
          <br />
          <br />
          <h2 className={"google-font " + classname}>
            <b className={classname}>Anti Harrasment Policy</b>
          </h2>
          <p className={"google-font " + classname}>
