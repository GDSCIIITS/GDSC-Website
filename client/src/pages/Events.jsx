  ...
  return (
    <React.Fragment>
      <CardContent style={props.theme ? dark : {}}>
        <Typography
          style={props.theme ? { ...dark, fontSize: 14 } : { fontSize: 14 }}
        ...
        <Typography
          ...
          component="div"
        >
          <b style={props.theme ? dark : {}}>Test Component</b>
        </Typography>
        <Typography
          style={props.theme ? { ...dark, mb: 1.5 } : { mb: 1.5 }}
          color="text.secondary"
        >
          Online/Offline
        </Typography>
        ...
        <Typography style={props.theme ? dark : {}} variant="body2">
          <b style={props.theme ? dark : {}}>
            <a
              href="mailto:gdsc@iiits.in"
              style={props.theme ? { ...dark, color: "#2c7eea" } : {}}
            >
              See more :)
            </a>
          </b>
...
function StickyHeadTable(props) {
  ...
  return (
    <Paper
      sx={
        props.theme
          ? { ...dark, width: "100%", overflow: "hidden" }
          : { width: "100%", overflow: "hidden" }
      }
    >
      <TableContainer
        sx={props.theme ? { ...dark, maxHeight: 440 } : { maxHeight: 440 }}
      >
        <Table
          stickyHeader
    ...
    <div className={classname}>
      <h2 className={`container ${styles.Events} ${classname}`}>
        <b className={classname}>
          Our{" "}
          <span className={styles.subheading + " " + classname}>Events</span>
        </b>
      </h2>
      ...
      <h2 className={`container ${styles.Events} ${classname}`}>
        <b className={classname}>
          Our{" "}
          <span className={styles.subheading + " " + classname}>
            Feature Event
          </span>{" "}
          & <span className={styles.subheading + " " + classname}>Meetups</span>
        </b>
      </h2>
      <div
        className={`container ${
        ...
        <p className={styles.maintext + " " + classname}>
          <Box sx={classname ? { ...dark, minWidth: 275 } : { minWidth: 275 }}>
            <Card
              style={
                classname
                  ? { ...dark, borderRadius: "100", outline: "solid grey" }
                  : { borderRadius: "100", outline: "solid grey" }
              }
            >
              {<CardOne theme={classname} />}
            </Card>
          </Box>
        </p>
      </div>
